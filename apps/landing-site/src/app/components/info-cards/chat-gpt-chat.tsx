/**
 * v0 by Vercel.
 * @see https://v0.dev/t/haUDVUryBdH
 */
import {
  AvatarImage,
  AvatarFallback,
    ...
    <div className="flex flex-col">
      <main className="flex-1 space-y-4 overflow-y-auto p-4">
        <div className="flex items-start space-x-2">
          <Avatar>
            <AvatarImage alt="@username" src="/ben.jpeg" />
        ...
        <div className="flex items-start space-x-2">
          <Avatar>
            <AvatarImage alt="@BenWerner" src="/ben.jpeg" />
            <AvatarFallback>BW</AvatarFallback>
          </Avatar>
          <div className="mt-2  flex flex-col space-y-2">
            <h2 className="text-sm font-semibold">Ben Werner</h2>
          ...
          <div className=" mt-2 flex flex-col space-y-2">
            ...
            <div className="flex items-start justify-between">
              <div className="max-w-[90%] rounded-lg  bg-secondary p-2 text-sm">
                ...
                <br />
                <UserText userText="Nick" /> will be adding engineers from the
                security team in his code review to ensure there are no
                vulnerabilities.
              </div>
            </div>
          </div>
